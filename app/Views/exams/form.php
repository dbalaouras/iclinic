        ...
        <form action="<?= $form_action; ?>" method="post">
            ...
            ?>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" readonly class="form-control-plaintext" required="true" id="id" name="id" value="<?= esc($exam['id']); ?>">
                    </div>
                </div>
            <?php } ?>
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="input" class="form-control" id="code" name="code" required="true" required="true" value="<?= esc($exam['code']); ?>">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select name="status" class="custom-select" required="true">
