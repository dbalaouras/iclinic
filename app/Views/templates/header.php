        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <div class="input-group">
                    <input class="form-control" type="text" placeholder="Αναζήτηση  ..." aria-label="Search" aria-describedby="basic-addon2" />
                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading"><i class="fas fa-hospital-user"></i> Εξετάσεις</div>
                            ...
                            <div class="sb-sidenav-menu-heading"><i class="fas fa-hospital-user"></i> Χειρουργεία</div>
